...
produtoHTML = `
        <img class="product-icon" src="../public/assets/product-icon.svg" alt="product-icon">
         <div class="product-informations-box">
                <div>Nome: <span class="produto nome">${matchingProduct.nome}</span><input class="js-edit-nome hiden inputProduto" type="text"> <img class="icon" data-edit="nome" src="../public/assets/edit-icon-black.svg" alt=""> </div>
                ...
                </select> <img class=" icon" data-edit="categoria" src="../public/assets/edit-icon-black.svg" alt=""></div>
                <div>Quantidade: <span class="produto quantidade">${matchingProduct.quantidade}</span><input class="js-edit-quantidade hiden inputProduto" data-edit="quantidade" type="number"> <img class=" icon" data-edit="quantidade" src="../public/assets/edit-icon-black.svg" alt=""></div>
                <div>Estoque Mínimo: <span class="produto estoqueMinimo">${matchingProduct.estoqueMinimo}</span><input class="js-edit-estoqueMinimo hiden inputProduto" type="number"> <img class=" icon" data-edit="estoqueMinimo" src="../public/assets/edit-icon-black.svg" alt=""></div>
                ...
                </select> <img class=" icon" data-edit="prateleira" src="../public/assets/edit-icon-black.svg" alt=""></div>
                <div>Fornecedor: <span class="produto fornecedor">${matchingProduct.fornecedor}</span><input class="js-edit-fornecedor hiden inputProduto" type="text"> <img class="icon" data-edit="fornecedor" src="../public/assets/edit-icon-black.svg" alt=""></div>
                <div>Data de entradada: <span class="produto dataEntrada">${matchingProduct.dataEntrada}</span><input class="js-edit-dataEntrada hiden inputProduto" type="date"> <img class=" icon" data-edit="dataEntrada" src="../public/assets/edit-icon-black.svg" alt=""></div>
        ...
        <div class="buttonsBox">
            ...
            <button class="js-excluir-btn button" id="excluir">excluir produto <img class="icon" src="../public/assets/close-icon.svg" alt=""></button>
        </div>
`;
